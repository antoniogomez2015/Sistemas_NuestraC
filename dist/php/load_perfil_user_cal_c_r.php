...
<!--load perfil de usuario | crear calendario de citas reservadas mobile-->
<section id="cal_c_r">
	...
	<div id="head">
		...
		<div id="mbil">
			...
			<div id="user" class="top"><span class="icon-user"></span>Suscribirse</div>
			<div id="menu" class="top"><span class="icon-list2"></span></div>
	...
	<div id="tabs">
		...
		<script type="text/javascript">
			...
			+function(){
				...
				$('#load_main').load('dist/php/load_perfil_user_dp.php');

			}();

			+function(){

				$('#load_main').load('dist/php/load_perfil_user_inf_m.php');
